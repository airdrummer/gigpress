function cptui_register_my_cpts_musician() {
	...
	$labels = [
		...
		"items_list_navigation" => esc_html__( "musician list navigation", "custom-post-type-ui" ),
		"items_list" => esc_html__( "musician list", "custom-post-type-ui" ),
		"attributes" => esc_html__( "musician attributes", "custom-post-type-ui" ),
	...
	$args = [
		...
		"labels" => $labels,
		"description" => "listing of active(published) & inactive(pending) performers, included in casts",
		"public" => true,
