...
jQuery(document).ready(function($) 
{
    ...
    if (allowInitialExpand && !mediaQuery.matches) {
        ...
        $rows.prop('open', true);
        masterOpenState = true;
    } else {
        // FALLBACK: Wrong page OR narrow viewport screen size = Initialize Closed
    ...
    {
        masterOpenState = !masterOpenState;
        $rows.prop('open', masterOpenState);
    });
});
</script>